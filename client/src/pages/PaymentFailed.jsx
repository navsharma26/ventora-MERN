    ...
    return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
            <div className="bg-white p-10 rounded-3xl shadow-2xl max-w-md w-full text-center border-t-8 border-red-500 transform transition-all hover:-translate-y-1">
                ...
                <h1 className="text-4xl font-black text-jade-950 mb-4">Booking Failed</h1>
                ...
                <div className="space-y-4">
                    ...
                    <Link to="/dashboard" className="block w-full bg-jade-50 hover:bg-jade-100 text-jade-900 font-bold py-4 px-6 rounded-xl transition border border-jade-100">
                        Go to Dashboard
                    </Link>
                </div>
            </div>
